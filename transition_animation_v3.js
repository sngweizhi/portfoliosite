...
function animateOnScroll() {
  const a_blocks = [
    ...
    { id: "block-f667b297baec4a138de37dcc008fd046", class: "reveal-3" },
    { id: "block-c36e69ea2e1e406393db07719790f5d6", class: "reveal-2" },
    { id: "block-3360bfc3d1d841239559c52e570998c2", class: "reveal-1" },
  ...
  a_blocks.forEach((block) => {
    ...
    if (el) {
      el.classList.add('reveal-on'); // Ensure the elements are initially hidden
